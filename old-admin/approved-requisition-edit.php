                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-headline">
                        <div class="panel-heading">
                            <h3 class="panel-title"><a href="alreadyapproved.php" class="btn btn-defualt btn-sm">Back</a></h3>
                            ...
                            <table  border="0" id="tbl_1" class="no_border" align="left" style="width: 320px; margin-right:100px">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td height="25">:</td>
                                    <td height="25"><?php echo $header_data['contact_number']; ?></td>
                                </tr>
                                ...
                                <tbody>
                                    ...
                                    <td><center><?php echo $i++; ?></center></td>
                                        ...
                                        <td><center>
                                             ...
                                             <button type="button" class="btn btn-primary btn-sm e" data-toggle="modal" data-target="#myModalitem<?php echo $item_data['id']; ?>">Edit</button>
