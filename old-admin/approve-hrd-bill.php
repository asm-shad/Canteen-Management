...
<div class="panel-body">
    <div class="row">
        ...
        <tbody>
            ...
            while($bill_data = $sql_requisition_HRHD_bill->fetch_assoc()){
       ...
       $billamount = $HR_Approve_Bill->fetch_assoc();        
            ...
            <table>
                <tr>
                  ...
                  <a href="rquhrdBillview.php?view_id=<?php echo md5($bill_data['id']); ?>" class="btn btn-primary btn-sm">Check</a>
         ...
         <?php 
          ...
          if ($tokenn==$token) {  ?>
               ...
               <button class="btn btn-success btn-sm HRheadBillSession" verify_code="<?php echo $verifycode; ?>" requitid="<?php echo $bill_data['id']; ?>" reqrefer="<?php echo $bill_data['reference']; ?>" data-toggle="modal" data-target="#myModalHRheadBill<?php echo $bill_data['id']; ?>" >Approve</button >
                  </td>
              ...
              <?php } else{ ?>
                  ...
                  <td style="padding-right: 2px;"> 
             <button class="btn btn-success btn-sm HRheadBillapproved" requit_id="<?php echo md5($bill_data['id']); ?>" requitid="<?php echo $bill_data['id']; ?>" reqrefer="<?php echo $bill_data['reference']; ?>" toekndata="<?php echo $tokenn; ?>" data-toggle="modal" data-target="#myModalHRheadBill<?php echo $bill_data['id']; ?>" vrfycode="<?php echo $vrfy_code; ?>">Approve </button >
                  </td>
      ...
      <?php } ?>
            ...
            <div class="modal fade" id="myModalHRheadBill<?php echo $bill_data['id']; ?>" role="dialog">
  ...
  <?php                               
    ...
    echo ('<SCRIPT LANGUAGE="JavaScript">
        ...
        $("#myModalHRheadBill'.$bill_data['id'].'").on("hidden.bs.modal", function () {
