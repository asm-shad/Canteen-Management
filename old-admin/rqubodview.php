...
// error_reporting(0);
    ...
    //$orderid = $_GET['orderid'];
	 ...
	 $sql = $db->query("SELECT * from canteen_header where md5(id)='$id' and approvedStatus='3'");
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-headline">
                        <div class="panel-heading">
                            <h3 class="panel-title"><a href="approve-bo.php" class="btn btn-defualt btn-sm">Back</a></h3>
...
<table  width="225" align="center" >
 ...
 <?php 
  ...
  if ($tokenn==$token) { ?>
        <td style="padding-left: 30px;">
           <button class="btn btn-success btn-sm BossSession" verify_code="<?php echo $verifycode; ?>" requitid="<?php echo $order_r['id']; ?>" reqrefer="<?php echo $order_r['reference']; ?>" data-toggle="modal" data-target="#myModalBoss<?php echo $order_r['id']; ?>" >Approve</button >

       </td>
    <?php } else{ ?>
        <td style="padding-left: 30px;">
           <button class="btn btn-success btn-sm Bossapproved" requit_id="<?php echo md5($order_r['id']); ?>" requitid="<?php echo $order_r['id']; ?>" reqrefer="<?php echo $order_r['reference']; ?>" toekndata="<?php echo $tokenn; ?>" data-toggle="modal" data-target="#myModalBoss<?php echo $order_r['id']; ?>" vrfycode="<?php echo $vrfy_code; ?>">Approve</button >
      ...
      <?php } } ?>
        ...
        <td style="padding-left: 30px;">
            ...
            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#myModalBossreject<?php echo $order_r['id']; ?>">
                  Reject
                </button> 
...
<!-- END MAIN CONTENT -->
    ...
    <div class="modal fade" id="myModalBoss<?php echo $order_r['id']; ?>" role="dialog">
    ...
    <div class="modal fade" id="myModalBossreject<?php echo $order_r['id']; ?>" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
...
<script LANGUAGE="JavaScript">
    ...
    $('#myModalBoss<?php echo $order_r["id"]; ?>').on('hidden.bs.modal', function () {
