            ...
            ?>
               ...
               <td><?php echo $itemdata ['itemname']; ?></td>
                ...
                <td><center>
                  ...
                  <a href="rquview.php?view_id=<?php echo md5($requisition_data['id']); ?>" class="btn btn-primary btn-sm">Check</a>
 ...
 <?php 
  ...
  ?>
        <td style="padding-left: 30px;">
           <button class="btn btn-success btn-sm noapproved" requiID="<?php echo md5($requisition_data['id']); ?>">Approve</button >
       </td>
  ...
  if ($tokenn==$token) {  ?>
       ...
       <button class="btn btn-success btn-sm HRconcernSession" verify_code="<?php echo $verifycode; ?>" requitid="<?php echo $requisition_data['id']; ?>" reqrefer="<?php echo $requisition_data['reference']; ?>" data-toggle="modal" data-target="#myModaldepartment<?php echo $requisition_data['id']; ?>" >Approve</button >
          </td>
      ...
      <?php } else{ ?>
          ...
          <td style="padding-right: 2px;"> 
     <button class="btn btn-success btn-sm HRconcernapproved" requit_id="<?php echo md5($requisition_data['id']); ?>" requitid="<?php echo $requisition_data['id']; ?>" reqrefer="<?php echo $requisition_data['reference']; ?>" toekndata="<?php echo $tokenn; ?>" data-toggle="modal" data-target="#myModaldepartment<?php echo $requisition_data['id']; ?>" vrfycode="<?php echo $vrfy_code; ?>" >Approve</button >
          </td>
