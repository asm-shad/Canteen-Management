...
$requestid = $_GET['view_id'];
 ...
 $sql_requisition = $db->query("select * from it_requisition where md5(id)='$requestid' and approved_status='4'");
...
<!-- END NAVBAR -->
            ...
            <table  width="225">
                 <tr>
                    <td><a href="bulk-verify.php" class="btn btn-defualt btn-sm">Back</a></td>
                     
                    </tr>
                </table>
                            
                         <!--    </p> -->
                         <fieldset style="margin-top: 5px;border: 1px solid #B7B7B7; border-radius:5px; margin-bottom:10px; padding-left: 5px;">
                ...
                <table  width="225" align="center" >
                 <tr>
                    ...
                    <td style="padding-left: 30px;">
                       <a class="btn btn-success btn-sm bulkapprovedSession" verify_code="<?php echo $verifycode; ?>" requitid="<?php echo $header_data['id']; ?>" data-toggle="modal" data-target="#blkmyModalbulk<?php echo $header_data['id']; ?>" >Verify</a >
                    </td>
                <?php } else{ ?>

                    <td style="padding-left: 30px;">
                       <a class="btn btn-success btn-sm bulkapproved" requit_id="<?php echo md5($header_data['id']); ?>" requitid="<?php echo $header_data['id']; ?>" toekndata="<?php echo $tokenn; ?>" data-toggle="modal" data-target="#blkmyModalbulk<?php echo $header_data['id']; ?>" >Verify</a >
                    </td>

                 <?php } ?>

                  <td style="padding-left: 30px;">                    
                    <a type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#blkmyModaldepartmentreject<?php echo $header_data['id']; ?>">
                          Reject
                        </a> 
                    </td>
    ...
    <div class="modal fade" id="blkmyModalbulk<?php echo $header_data['id']; ?>" role="dialog">
    ...
    <div class="modal fade" id="blkmyModaldepartmentreject<?php echo $header_data['id']; ?>" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
...
<?php 
 ...
 echo ('<SCRIPT LANGUAGE="JavaScript">
    ...
    $("#blkmyModalbulk'.$header_data['id'].'").on("hidden.bs.modal", function () {
