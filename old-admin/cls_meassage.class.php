...
public function add_application(
		...
		application_date,status,category,living_status,priority,location_distance,live_with_family,create_user)
		VALUES
        ('$employee_id','$name','$designations','$mobile','$joining_date','$section_or_department','$employer_factory','$level',
     		'$application_date','$status','$category','$living_status','$priority','$location_distance','$live_with_family','$username')
    	";
