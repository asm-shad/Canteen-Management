    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-headline">
            <div class="panel-heading">
                <h3 class="panel-title"><a href="bill-approve-by-HR.php" class="btn btn-defualt btn-sm">Back</a></h3>
                ...
                <fieldset style="border: 1px solid #B7B7B7; border-radius:5px; margin-bottom:10px; padding-left: 5px;">
                    ...
                    <table border="0" id="tbl_1" class="no_border" align="left" style="width: 420px; margin-right:30px">
                    ...
                    <table border="0" id="tbl_1" class="no_border" align="left" style="width: 420px; margin-right:10px">
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-examples">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <center>Rqi QTY</center>
                                    </th>
                                    <th>
                                        <center>Approve QTY</center>
                                    </th>
                                    <th>
                                    ...
                                    <th>
                                        <center>Unit Purchase Price</center>
                                    </th>
                                    <th>
                                        <center>Total Purchase Price</center>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <center><?php echo $item_data['PurUnitPrice']; ?></center>
                                        </td>
                                        <td>
                                            <center><?php echo $item_data['PurTotalPrice']; ?></center>
                                        </td>
                                    </tr>
