...
// error_reporting(0);
    ...
    //$orderid = $_GET['orderid'];
     ...
     $sql = $db->query("SELECT * from canteen_header where md5(id)='$id' and approvedStatus='7'");
...
<div class="container-fluid">
    ...
    <div class="panel panel-headline">
        <div class="panel-heading">
            <h3 class="panel-title"><a href="approve-admin-bill.php" class="btn btn-defualt btn-sm">Back</a></h3>
         ...
         <?php 
          ...
          if ($tokenn==$token) { ?>
                <td style="padding-left: 30px;">
                   <button class="btn btn-success btn-sm AdminBillSession" verify_code="<?php echo $verifycode; ?>" requitid="<?php echo $order_r['id']; ?>" reqrefer="<?php echo $order_r['reference']; ?>" data-toggle="modal" data-target="#myModalAdminBill<?php echo $order_r['id']; ?>" >Approve</button >

               </td>
            <?php } else{ ?>
                <td style="padding-left: 30px;">
                   <button class="btn btn-success btn-sm AdminBillapproved" requit_id="<?php echo md5($order_r['id']); ?>" requitid="<?php echo $order_r['id']; ?>" reqrefer="<?php echo $order_r['reference']; ?>" toekndata="<?php echo $tokenn; ?>" data-toggle="modal" data-target="#myModalAdminBill<?php echo $order_r['id']; ?>" vrfycode="<?php echo $vrfy_code; ?>">Approve </button >
...
<!-- END MAIN CONTENT -->
       ...
       <!-- Modal myModalAdminBill approve-->
    <div class="modal fade" id="myModalAdminBill<?php echo $order_r['id']; ?>" role="dialog">
...
<script LANGUAGE="JavaScript">
    ...
    $('#myModalAdminBillt<?php echo $order_r["id"]; ?>').on('hidden.bs.modal', function () {
