...
include('header.php');
    ...
    //$orderid = $_GET['orderid'];
	 ...
	 $sql = $db->query("select * from it_requisition where md5(id)='$id' and approved_status='0'");
...
<script>
   ...
   $("#btnPrint").live("click", function () {
    ...
    <body>
    <div style="padding-top: 10px; text-align: center;"><h3>Waiting Section Approval</h3></div>
<br>
    <table  width="225" align="center" >
        ...
        <td style="padding-left: 30px;">
          ...
          <button class="btn btn-success btn-sm approvedSession" verify_code="<?php echo $verifycode; ?>"  requitid="<?php echo $order_r['id']; ?>" data-toggle="modal" data-target="#myModalsection<?php echo $order_r['id']; ?>" >Approve</button >
        ...
        <td style="padding-left: 30px;">
          ...
          <button class="btn btn-success btn-sm approvedID" requit_id="<?php echo md5($order_r['id']); ?>" requitid="<?php echo $order_r['id']; ?>" toekndata="<?php echo $tokenn; ?>" data-toggle="modal" data-target="#myModalsection<?php echo $order_r['id']; ?>" >Approve</button >
        ...
        <td style="padding-left: 30px;">
            ...
            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#myModalsectionreject<?php echo $order_r['id']; ?>">
                  Reject
                </button> 
    ...
    <div class="modal fade" id="myModalsection<?php echo $order_r['id']; ?>" role="dialog">
    ...
    <div class="modal fade" id="myModalsectionreject<?php echo $order_r['id']; ?>" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
...
<table width="825" border="1" align="center" cellpadding="0" cellspacing="0" class="shawdow">
  ...
  <tr>
    <td height="22"><b>Cost Center:</b> <?php echo $costsql_r['company_name']; ?> </td>
    </tr>
      <tr>
...
$('#cmd').click(function () {   
 ...
 <script LANGUAGE="JavaScript">
        ...
        $('#myModalsection<?php echo $order_r['id'] ?>').on('hidden.bs.modal', function () {
