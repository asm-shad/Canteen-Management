                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables">
                            ...
                            <tbody>
                                ...
                                $sql_requisition_depart_approve_log = $db->query("SELECT
                                    ...
                                    -- get actual approval record
                                    LEFT JOIN approve_verify ap
                                        ON c.reference = ap.reference
                                        AND ap.status = '1'   -- approved
                                        AND ap.processName IN ('HR Head Approve', 'Boss')

                                    -- get approver name
                                    LEFT JOIN user u
                                        ON ap.userID = u.employeeID

                                    WHERE
                                        c.status = '1'
                                        AND c.approvedStatus BETWEEN 1 AND 7
                                        AND EXISTS (
                                            SELECT 1
                                            FROM user_role ur
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <center><a href="viewaproved.php?view_id=<?php echo md5($requisition_data['id']); ?>" class="btn btn-primary btn-sm">VIEW</a>
