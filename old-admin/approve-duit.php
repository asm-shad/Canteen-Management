...
<div class="panel-body">
    <div class="row">
        ...
        <tbody>
            ...
            while($bill_data = $sql_requisition_audit_bill->fetch_assoc()){
       ...
       $billamount = $HR_Approve_Bill->fetch_assoc();        
            ...
            <table>
                <tr>
                  ...
                  <a href="rquauditdview.php?view_id=<?php echo md5($bill_data['id']); ?>" class="btn btn-primary btn-sm">Check</a>
 ...
 <?php 
  ...
  ?>
        <td style="padding-right: 2px;">
           <button class="btn btn-success btn-sm AuditPriceadd">Approve</button >
       </td>
    ...
    <?php 
          ...
          if ($tokenn==$token) {  ?>
                ...
                <td style="padding-right: 2px;"> 
               <button class="btn btn-success btn-sm AuditBillSession" verify_code="<?php echo $verifycode; ?>" requitid="<?php echo $bill_data['id']; ?>" reqrefer="<?php echo $bill_data['reference']; ?>" data-toggle="modal" data-target="#myModalAuditBill<?php echo $bill_data['id']; ?>" >Approve</button >
                  </td>
              ...
              <?php } else{ ?>
                  ...
                  <td style="padding-right: 2px;"> 
             <button class="btn btn-success btn-sm AuditBillapproved" requit_id="<?php echo md5($bill_data['id']); ?>" requitid="<?php echo $bill_data['id']; ?>" reqrefer="<?php echo $bill_data['reference']; ?>" toekndata="<?php echo $tokenn; ?>" data-toggle="modal" data-target="#myModalAuditBill<?php echo $bill_data['id']; ?>" vrfycode="<?php echo $vrfy_code; ?>">Approve</button >
                  </td>
      ...
      <?php }  } ?>
            ...
            <div class="modal fade" id="myModalAuditBill<?php echo $bill_data['id']; ?>" role="dialog">
  ...
  <?php                               
    ...
    echo ('<SCRIPT LANGUAGE="JavaScript">
        ...
        $("#myModalAuditBill'.$bill_data['id'].'").on("hidden.bs.modal", function () {
