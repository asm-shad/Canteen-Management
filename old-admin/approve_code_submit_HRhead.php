...
echo $cls_meassage->approve_HRhead_submit_access($hiddenID,$verifycode,$username,$employeeID);
...
$upName  	= $canteen_data['requesterName'];
$upEmail 	= $canteen_data['email'];
...
// Content
$mail->isHTML(true);  
$mail->Subject = 'Waiting for Receipts';  
$mail->Body    = '<!DOCTYPE HTML>'. 
'<head>'. 
'<meta http-equiv="content-type" content="text/html">'.
'<title>Waiting for Receipts</title>'. 
'</head>'. 
'<body>'.
                   ...
                   ' <td valign="top">'.
                    ...
                    '<tr>'.
                        '<td valign="top">'.
                            ...
                            '<a href="http://localhost/canteen-management/admin/login.php?redirect=requisition-edit.php?req_id='.$mid.'" style="font-size:19px;font-weight:normal;line-height:22px;margin:0 0 11px 0">'.'Waiting for Receipts <b>'.$reference.' '.'</b></a>'.
                        '</td>'.
                    '</tr>'.
                    '<tr>'.
                      '<td>'.
