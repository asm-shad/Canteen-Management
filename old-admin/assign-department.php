...
<div class="panel panel-headline">
    <div class="panel-heading">
        <h3 class="panel-title">Approval Role Assign</h3>
        ...
        <div class="row">
            ...
            <?php
             if($_SESSION['user_role']=="Admin"){
                ...
                <form id="assigndepartment" method="post">
            ...
            <?php
                ...
                while($role_data = $all_department_role->fetch_assoc()){
                ...
                ?>
                    ...
                    <td><center>
                        <a href="assign-department-edit.php?assign_id=<?php echo md5($role_data['id']); ?>" class="btn btn-primary">Edit</a>
                    </center></td>
