                    ...
                    while($reqdata = $sql_requisition_statuss->fetch_assoc()){                                  
                        ...
                        <td><center>
                                <?php if($reqdata['approvedStatus'] == '0') {
                                    ...
                                    echo "Rejected from ".$reqdata['rejectUser'];
                                }                                            
                        ...
                        <td><center>
                           ...
                           <a target="_blank" href="printview.php?view_id=<?php echo md5($reqdata['id']); ?>&user=<?php echo $userID;?>" class="btn btn-secondary btn-sm" style="width: 98px !important;">Print Requisition</a>
