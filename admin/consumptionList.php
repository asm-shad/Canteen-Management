...
$list_consumption = $cls_meassage->all_show_consumption_admin();
                        ...
                        while($data = $list_consumption->fetch_assoc()){    ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="consumption-admin-edit.php?item_id=<?php echo md5($data['id']); ?>" class="btn btn-info btn-sm">Edit</a>
