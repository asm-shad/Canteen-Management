      ...
      ON c.PurchaseFor = r.category and c.costDivision=r.companyID LEFT JOIN canteen_line a ON c.reference =a.reference LEFT JOIN approve_verify apvi ON c.reference = apvi.reference where r.user_name='$username' and c.status='1' and r.user_type='Boss' and apvi.status = '1' and apvi.approvalType='Boss' and c.approvedStatus BETWEEN 2 and 7 GROUP BY c.id");
            ...
            ?>
               ...
               <!--  <td><center>Active</center></td> -->
                ...
                <td><center><a href="viewBossaproved.php?view_id=<?php echo md5($requisition_data['id']); ?>" class="btn btn-primary btn-sm">VIEW</a>
