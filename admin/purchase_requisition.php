...
// muster query
$sqlrequisition = $db->query("SELECT * FROM canteen_header where md5(id)='$urlid'");
...
$sql_verify_section_head = $db->query("select * from approve_verify where requisition_id='$reqid'");

$verify_section = $sql_verify_section_head->fetch_assoc();

$section_verifyid = $verify_section['username'];

$sql_signature_section_head = $db->query("select * from user where username ='$section_verifyid'");

$verify_section_sign = $sql_signature_section_head->fetch_assoc();
...
$verifyby = $db->query("select * from user where employeeID ='LH1225'");
...
<body>
        ...
        <div id="printableArea" style="">
                    ...
                    <table class="table table-bordered" border="1" align="center" cellpadding="0" cellspacing="0" style="width: 1562px; text-align: center; font-size: 13px;">
                        <thead>
                            <tr>
                                ...
                                <th height="40" scope="col">Dept Stock Qty</th>
                                <th height="40" scope="col">Store Balance Qty</th>
                                <th height="40" scope="col">Final Required Qty</th>
                                <th height="40" scope="col">Unit</th>
                                <th height="40" scope="col">Monthly Average uses Qty</th>
                        ...
                        $ii= 1;
                            ...
                            <tr>
                                ...
                                <td height="40" style="padding-left:2px;padding-right:2px;"><?php echo $data_r['section']; ?></td>
                    ...
                    <div class="row" style="padding-top:5px;">
                        ...
                        <div class="col-sm">
                         ...
                         <td>
                            <div class="col-sm"><br>
                                <div style="text-align: center; padding-top: 5px;width: 200px;">
                                    <img src="<?php echo $verify_section_sign['signature']; ?>" style="height: 40px; width:120px"> 
                                    <hr style="margin-bottom:0px;margin-top: 0px;border-bottom: 1px solid rgba(0,0,0);">
                            <p style="margin: 2px; text-align: left;font-size: 11px;font-weight: 800"> Approved By: <br>Section/Cost Center <br>
                              <?php echo $verify_section_sign['name']; ?><br>
                                <?php echo $verify_section_sign['designation']; ?>
                                    </p>
                                </div>
                            </div>
         ...
         <!--    <td>
                <div class="col-md-3">
                    <div class="card" style="width: 230px;height: 100px;float: right;position: relative;display: -ms-flexbox;display: flex;-ms-flex-direction: column;flex-direction: column;min-width: 0;word-wrap: break-word;background-color: #fff;background-clip: border-box; border: 1px solid rgba(0,0,0);border-radius: 0.25rem;">
                        <div class="card-body" style=" -ms-flex: 1 1 auto;flex: 1 1 auto; min-height: 1px; padding: 1.25rem;">
                            <p style="margin-left: 0px !important;margin-top: 0px; text-align: left;font-size: 9px;">For on Behelf of <br> Liz Fashion Industry Limited</p>
                            
                            <p style="margin-left: 0px !important;margin-top: 50px; text-align: left;font-size: 9px;"> Signature:</p>
                        </div>
                    </div>
                </div>
                </td> -->
