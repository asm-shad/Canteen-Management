...
$all_application = $cls_meassage->eligible_application_information_general($username);
    ...
    <div class="container-fluid">
        <div class="panel panel-headline">
            <div class="panel-heading">
                <h3 class="panel-title">General Canteen Applicants Information (Requested Applicants Only)
                                        ...
                                        <td>
                                            <div style="display: inline-block;">
                                                ...
                                                <div style="display: flex; gap: 4px; margin-bottom: 3px;">
                                                    ...
                                                    <button class="btn btn-success btn-mini" style="width: 55px;"
                                                ...
                                                <div style="display: flex; gap: 4px; margin-bottom: 3px;">
                                                    ...
                                                    <a href="updateApplication.php?id=<?= $data['id'] ?>&return_page=eligibleGeneral.php">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-bordered " style="font-size: 16px;">
                 ...
                 <p style="color: red; font-size: 10px; margin-top: 0px;">Note: If priority is set, total point becomes 100 automatically.
            </p>
            </div>
...
<script>
    ...
    //         ordering: false, // disable automatic asc/desc
    //         paging: true, // enable pagination
    //         pageLength: 10, // rows per page
    //         lengthChange: true, // user can select number of rows
    //     });
    // });
    ...
    //     var table = document.getElementById('canteenTable');
    //     var rows = table.querySelectorAll('tbody tr');
    //     var filters = table.querySelectorAll('thead tr:nth-child(2) .filter-input');
    ...
    //             var cellText = cells[index].innerText.trim().toLowerCase();
    ...
    //             } else {
    //                 if (cellText.indexOf(filterValue) === -1) showRow = false;
    //             }
    //         });
    ...
    function notAcceptApplication(appId) {
        ...
        $.ajax({
            ...
            success: function(response) {
                // Hide any open modals if needed
                $('#acceptModal').modal('hide');
                location.reload();
            },
            error: function() {
